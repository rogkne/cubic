...
The command prints a note that changes may require a restart. It applies to the
other settings of a VM instance, such as CPUs and memory, not to the forwards.
